...
<div class="main_cont_outer">
    <div class="create_btn">
        <a href="{{ route('client_services.index', encode_id($client->id)) }}" class="btn btn-primary create-button btn_primary_color"
    ...
    <div class="card card-container">
        <div class="card-body">
            <form action="{{ route('client_services.store', $client->id) }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-primary btn_primary_color"> {{ __('messages.add_service') }} </button>
            </form>
        </div>
    </div>
</div>
