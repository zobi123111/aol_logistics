            ...
            <form action="{{ route('suppliers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="user_role" class="form-select">
                        <option value="master_lient" {{ old('user_role') == 'master_lient' ? 'selected' : '' }}>Master
                            Client</option>
                        <option value="customer_service_executve"
                            {{ old('user_role') == 'customer_service_executve' ? 'selected' : '' }}>Customer Service
                            Executive</option>
                        <option value="accountng_user" {{ old('user_role') == 'accountng_user' ? 'selected' : '' }}>
